...
int main() {
     ...
     for (int i = 1; i < number_of_students; i++) {
         cout << "Student #" << i << ": ";
         for (int i1 = 1; i1 < number_of_classes1; i1++) {
             float credits, mark;
             cout << "Enter total credits: "; cin >> credits;
             cout << "Enter marks for class: "; cin >> mark;
     ...
     for (int i = 1; i <= number_of_numbers; i++) {
         cout << i << "*" << i << " = " << i*i << endl;
         sum_of_squares = i*i;
         sum_1 += sum_of_squares;
     }
     cout << sum_1 << endl;

    //Problem 11
    int num, positiveCount = 0, negativeCount = 0, total = 0;
    int count_1 = 0;

    cout << "Enter a integer (enter 0 to stop): " << endl;
    ...
    if (count_1 == 0) {
        cout << "No nonzero numbers were entered." << endl;
    } else {
        float average = (total) / count_1;
